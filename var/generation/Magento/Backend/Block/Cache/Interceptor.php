...
class Interceptor extends \Magento\Backend\Block\Cache implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFlushStorageUrl');
        if (!$pluginInfo) {
            return parent::getFlushStorageUrl();
        } else {
            return $this->___callPlugins('getFlushStorageUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFlushSystemUrl');
        if (!$pluginInfo) {
            return parent::getFlushSystemUrl();
        } else {
            return $this->___callPlugins('getFlushSystemUrl', func_get_args(), $pluginInfo);
        }
    }
