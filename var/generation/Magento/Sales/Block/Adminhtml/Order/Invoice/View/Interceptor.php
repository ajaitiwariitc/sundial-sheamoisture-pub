...
class Interceptor extends \Magento\Sales\Block\Adminhtml\Order\Invoice\View implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCaptureUrl');
        if (!$pluginInfo) {
            return parent::getCaptureUrl();
        } else {
            return $this->___callPlugins('getCaptureUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getVoidUrl');
        if (!$pluginInfo) {
            return parent::getVoidUrl();
        } else {
            return $this->___callPlugins('getVoidUrl', func_get_args(), $pluginInfo);
        }
    }
