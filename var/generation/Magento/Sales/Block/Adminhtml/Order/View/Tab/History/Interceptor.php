...
class Interceptor extends \Magento\Sales\Block\Adminhtml\Order\View\Tab\History implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function getItemCreatedAt(array $item, $dateType = 'date', $format = 2)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemCreatedAt');
        if (!$pluginInfo) {
            return parent::getItemCreatedAt($item, $dateType, $format);
        } else {
            return $this->___callPlugins('getItemCreatedAt', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemTitle');
        if (!$pluginInfo) {
            return parent::getItemTitle($item);
        } else {
            return $this->___callPlugins('getItemTitle', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isItemNotified');
        if (!$pluginInfo) {
            return parent::isItemNotified($item, $isSimpleCheck);
        } else {
            return $this->___callPlugins('isItemNotified', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemComment');
        if (!$pluginInfo) {
            return parent::getItemComment($item);
        } else {
            return $this->___callPlugins('getItemComment', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isCustomerNotificationNotApplicable');
        if (!$pluginInfo) {
            return parent::isCustomerNotificationNotApplicable($historyItem);
        } else {
            return $this->___callPlugins('isCustomerNotificationNotApplicable', func_get_args(), $pluginInfo);
        }
    }
